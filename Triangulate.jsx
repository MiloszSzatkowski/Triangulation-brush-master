...
function test (val, val2) {  alert ('test' + val.toString() + val2.toString() );  }
...
var Tswirl_X_count_text = First_Tab.add ('edittext', undefined, 5);

var slider_1 = First_Tab.add ("slider", undefined, 5, 2, 50);
...
var Tswirl_Y_count_text = First_Tab.add ('edittext', undefined, 5);

var slider_2 = First_Tab.add ("slider", undefined, 5, 2, 50);
